        ...
        <div className='w-full bg-white'>
            ...
            <div className='w-[85%] lg:w-[90%] mx-auto'>
              <div className='flex w-full justify-between items-center h-[50px] text-slate-500 '>
                 <ul className='flex justify-start items-center gap-8 font-semibold text-black'>
                    ...
                    text-sm after:absolute after:h-[18px] after:w-[1px] after:bg-[#afafaf] 
                    after:-right-[16px]'>
                    <span>
                        <MdEmail/>
                    </span>
                    <span>support@gmail.comn</span>
                    </li>
                    <li className='flex relative justify-center items-center gap-2 
                    text-sm '>
                    <span>
                ...
                <div>
                    <div className='flex justify-center items-center gap-10'>
                        ...
                        <div className='flex group cursor-pointer text-slate-800 text-sm justify-center items-center gap-1
                         relative after:h-[18px] after:w-[1px] after:bg-[#afafaf] after:-right-[16px] after:absolute 
                         before:absolute before:h-[18px] before:bg-[#afafaf] before:w-[1px] before:-left-[20px] '>
                            <img src="https://shariv-shop.netlify.app/images/language.png" alt="">
                            </img>
                             <span>
                                <IoMdArrowDropdown/>
                             </span>
                        ...
                        {
                            userInfo ? <Link className='flex cursor-pointer justify-center items-start gap-2 text-sm text-black' to='/dashboard'>
                                <span> <FaUser/></span>
         ...
         <div className='w-[85%] lg:w-[90%] mx-auto'>
            <div className='h-[80px] md-lg:h-[100px] flex justify-between items-center flex-wrap'>
                ...
                <Link to='/'>
                    <img src="https://shariv-shop.netlify.app/images/logo.png" alt="" />
                </Link>
                <div className='justify-center items-center w-[30px] h-[30px] bg-white text-slate-600 border
                 border-slate-600 rounded-sm cursor-pointer lg:hidden md-lg:flex xl:hidden hidden' onClick={() => SetShowSideBar(false)}>
                    <span> <FaList/> </span>
                </div>
                </div> 
                </div>
            ...
            <div className='md:lg:w-full w-9/12'>
                ...
                {
                    wishlist_count !== 0 && <div className='w-[20px] h-[20px] absolute bg-red-500 rounded-full text-white flex justify-center items-center -top-[3px] -right-[5px] '> {wishlist_count}
                    </div>
                }
