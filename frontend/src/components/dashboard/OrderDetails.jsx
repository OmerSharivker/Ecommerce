...
const OrderDetails = () => {
    ...
    return (
        <div className='bg-white p-5'> 
            <h2>#{myOrder._id} , <span className='pl-1'>{myOrder.date}</span></h2>
                ...
                <div className='text-slate-600'>
                    <h2>
                     ...
                     <p className='font-mono'> 
                       Payment Status : <span className={`py-[1px] text-xs px-3 ${myOrder.payment_status ==='paid' ? 'bg-green-300 text-green-800' : 'bg-red-300 text-red-800'} rounded-md`}>
