...
const OrderDetails = () => {
    ...
    const status_update = (e) => {
        dispatch(seller_order_status_update({orderId, info: {status: e.target.value,sellerId : userInfo._id} }))
    ...
    useEffect(() => {
        const obj={
            orderId , sellerId:userInfo._id 
        }
        console.log(obj)
        dispatch(get_seller_order(obj))
    },[orderId])
             ...
             <span>Price : ${order.price}</span> 
             {
                        ...
                        <div className='text-[#d0d2d6]'>
                            <div className='flex gap-3 text-md'>
                                <img className='w-[50px] h-[50px]' src={p.images[i]} alt="" />
                                ...
                                <div>
                                    ...
                                    <p>
                                        ...
                                        <span className='text-lg ml-3'>Quantity : {p.quantity} </span>
                                    </p>
                                </div> 
                            </div> 
                        </div>
