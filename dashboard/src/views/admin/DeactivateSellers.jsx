        ...
        <tbody>
            {
                ...
                <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>Omer Sharivker </td>
                <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>Sharivker@gmail.com</td>
                <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>
                    <span>Pending</span> </td>
                    <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>
                    <span>Deactivate</span> </td>
