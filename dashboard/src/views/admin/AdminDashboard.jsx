    ...
    return (
            ...
            <div className='w-full lg:w-5/12 lg:pl-4 mt-6 lg:mt-0'>
              <div className='w-full bg-[#6a5fdf] p-4 rounded-md text-[#d0d2d6]'>
                <div className='flex justify-between items-center'>
                    ...
                    <Link to={'https://shariv-dashboard.netlify.app/admin/dashboard/chat-sellers'}  className='font-semibold text-sm text-[#d0d2d6]'> View All</Link>
                </div>
        ...
        <div className='w-full p-4 bg-[#6a5fdf] rounded-md mt-6'>
            <div className='flex justify-between items-center'>
                ...
                <Link to={'https://shariv-dashboard.netlify.app/admin/dashboard/orders'}  className='font-semibold text-sm text-[#d0d2d6]'>View All</Link>
               </div>
        ...
        <tbody>
      
            {
                ...
                <td scope='row' className='py-3 px-4 font-medium whitespace-nowrap'>
                    <Link to={`https://shariv-dashboard.netlify.app/admin/dashboard/order/details/${o._id}`} className="text-green-500 hover:underline">
                        View
                    </Link>
                    </td>
