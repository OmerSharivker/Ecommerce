        ...
        <tbody>
            {
                ...
                <td scope='row' className='py-2 px-4 font-medium whitespace-nowrap'>Omer Sharivker </td>
                <td scope='row' className='py-2 px-4 font-medium whitespace-nowrap'>Sharivker@gmail.com</td>
