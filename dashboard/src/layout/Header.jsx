...
const Header = ({showSideBar,setShowSideBar}) => {
    return (
        <div className='fixed top-0 left-0 w-full py-5 px-2 lg:px-7 z-40'>
            ...
            <div onClick={ ()=> setShowSideBar(!showSideBar)} className='w-[35px] flex lg:hidden h-[35px] rounded-md bg-indigo-500 shadow-lg
            hover:shadow-indigo-500/50 justify-center items-center cursor-pointer'>
                <span><FaList/></span>

            </div>
            <div className='hidden md:block'>
                <input className='px-3 py-2 outline-none border bg-transparent border-slate-700 rounded-md text-[#423d72] focus:border-indigo-300 overflow-hidden'
          ...
          <h2 className='text-md font-bold'>Omer Sharivker</h2>
